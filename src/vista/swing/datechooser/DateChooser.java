...
public final class DateChooser extends JPanel {
	...
	private vista.swing.datechooser.Button cmdPrevious;
	private vista.swing.datechooser.Button cmdForward;
	private vista.swing.datechooser.Slider slide;
	private javax.swing.JLayeredPane MY;
	private vista.swing.datechooser.Button cmdMonth;
	private vista.swing.datechooser.Button cmdYear;
	...
	public DateChooser() {
		slide = new vista.swing.datechooser.Slider();
		slide.setBounds(0, 32, 970, 644);
		add(slide);
		slide.setLayout(new BoxLayout(slide, BoxLayout.LINE_AXIS));
		setLayout(null);
		JPanel header = new JPanel();
		header.setBounds(0, 0, 968, 32);
		header.setBackground(new Color(252, 129, 129));
		add(header);
		header.setLayout(null);

		cmdPrevious = new vista.swing.datechooser.Button();
		...
		cmdPrevious.setIcon(new ImageIcon(DateChooser.class.getResource("/vista/swing/datechooser/previous.png")));
		cmdPrevious.setPaintBackground(false);
		header.add(cmdPrevious);

		cmdForward = new vista.swing.datechooser.Button();
		cmdForward.setBounds(925, 3, 30, 27);
		cmdForward.setIcon(new ImageIcon(DateChooser.class.getResource("/vista/swing/datechooser/forward.png")));
		cmdForward.setPaintBackground(false);
		cmdForward.setBorder(null);
		...
		MY.setBounds(371, 3, 195, 27);
		header.add(MY);

		cmdMonth = new vista.swing.datechooser.Button();
		...
		cmdYear = new vista.swing.datechooser.Button();
	...
	private void setText(boolean runEvent, int act) {
	    if (textRefernce != null) {
	        try {
	            ...
	            textRefernce.setText(formattedDate);
	...
	public void showPopup() {
	    popup.setPreferredSize(new Dimension(767, 466));
